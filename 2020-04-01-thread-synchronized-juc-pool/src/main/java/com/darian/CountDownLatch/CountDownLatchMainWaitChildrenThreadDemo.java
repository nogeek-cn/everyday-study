 ...
 */
public class CountDownLatchMainWaitChildrenThreadDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < countDownLatchCount; i++) {
            new CountDownLatchCountDownThread(i, countDownLatch).start();
        }
...
class CountDownLatchCountDownThread extends Thread {
    private final CountDownLatch countDownLatch;

    CountDownLatchCountDownThread(int i, CountDownLatch countDownLatch) {
